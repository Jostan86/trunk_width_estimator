...
class TrunkWidthEstimator:
    ...
    def get_width(self, image, pc):
        ...
        # Get the mask of the trunk
        vis_imgs2, mask, score, x, y = self.segmenter.get_mask(image, 0.2)

        # If there is no mask, return -1
        if score == -1:
            return None, None, None
        # Get the width of the trunk
        self.calculate_width(mask, pc, image)
        return self.width, vis_imgs2, mask
